...
public class ImplementArrayBlockingQueueAPI<E> {
     ...
     **/
    public ImplementArrayBlockingQueueAPI(int capacity) {
     ...
     **/
    public ImplementArrayBlockingQueueAPI(int capacity, boolean fair) {
     ...
     **/
    public ImplementArrayBlockingQueueAPI(int capacity, boolean fair, Collection<? extends E> c) {
    ...
    public static void main(String... arg) {
        ImplementArrayBlockingQueueAPI<Integer> arrayBlockingQueue = new ImplementArrayBlockingQueueAPI<Integer>(10);
        try {
