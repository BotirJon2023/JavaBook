...
public class ImplementLinkedListAPI<E> {
    private LinkedList<E> linkedList;

    public ImplementLinkedListAPI() {
        linkedList = new LinkedList<E>();
    }

    public ImplementLinkedListAPI(Collection<? extends E> c) {
    ...
    public static void main(String... arg) {
        ImplementLinkedListAPI<Integer> linkedList = new ImplementLinkedListAPI<>();
        linkedList.add(100);
        linkedList.add(20);
