...
public class FindGCDAndLCMOfTwoNumbersUsingEuclidAlgorithm {
    ...
    {
        FindGCDAndLCMOfTwoNumbersUsingEuclidAlgorithm abc = new  FindGCDAndLCMOfTwoNumbersUsingEuclidAlgorithm();
