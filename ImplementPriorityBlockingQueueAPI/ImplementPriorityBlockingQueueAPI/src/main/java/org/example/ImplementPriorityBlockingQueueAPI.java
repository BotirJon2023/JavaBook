...
public class ImplementPriorityBlockingQueueAPI<E> {
    private PriorityBlockingQueue<E> priorityBlockingQueue;

    /**
     * Creates an initially empty LinkedTransferQueue.
     **/
    public ImplementPriorityBlockingQueueAPI() {
     ...
     **/
    public ImplementPriorityBlockingQueueAPI(Collection<? extends E> c) {
     ...
     **/
    public ImplementPriorityBlockingQueueAPI(int initialCapacity) {
     ...
     **/
    public ImplementPriorityBlockingQueueAPI(int initialCapacity, Comparator<? super E> comparator) {
    ...
    public static void main(String... arg) {
        ImplementPriorityBlockingQueueAPI<Integer> priorityBlockingQueue = new ImplementPriorityBlockingQueueAPI<Integer>();
