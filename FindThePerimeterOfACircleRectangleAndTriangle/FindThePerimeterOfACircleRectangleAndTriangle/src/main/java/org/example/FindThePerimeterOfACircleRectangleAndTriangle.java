...
public class FindThePerimeterOfACircleRectangleAndTriangle {
    ...
    public static void main(String[] args) {
        FindThePerimeterOfACircleRectangleAndTriangle obj = new FindThePerimeterOfACircleRectangleAndTriangle();
        obj.circle();
        obj.rectangle();
        obj.triangle();
    }
