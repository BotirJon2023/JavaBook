...
public class ProgramToImplementHashTableAPI <K, V> {
     ...
     */
    public ProgramToImplementHashTableAPI()
    {
     ...
     */
    public ProgramToImplementHashTableAPI(int initialCapacity)
    {
     ...
     */
    public ProgramToImplementHashTableAPI(int initialCapacity, float loadFactor)
    {
        hashTable = new Hashtable<K, V>(initialCapacity, loadFactor);
    }

    /* Constructs a new hashtable with the same mappings as the given Map. */
    public ProgramToImplementHashTableAPI(Map<? extends K, ? extends V> t)
    {
    ...
    {
        ProgramToImplementHashTableAPI<Integer, Integer> hashTable = new ProgramToImplementHashTableAPI<Integer, Integer>();
