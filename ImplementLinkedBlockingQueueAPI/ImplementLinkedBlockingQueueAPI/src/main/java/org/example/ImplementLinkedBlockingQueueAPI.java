...
public class ImplementLinkedBlockingQueueAPI<E> {
    private LinkedBlockingQueue<E> linkedBlockingQueue;

    /** Creates a LinkedBlockingQueue with a capacity of Integer.MAX_VALUE. **/
    public ImplementLinkedBlockingQueueAPI()
    {
     ...
     **/
    public ImplementLinkedBlockingQueueAPI(Collection<? extends E> c)
    {
        linkedBlockingQueue = new LinkedBlockingQueue<E>(c);
    }

    /** Creates a LinkedBlockingQueue with the given (fixed) capacity. **/
    public ImplementLinkedBlockingQueueAPI(int capacity)
    {
    ...
    {
        ImplementLinkedBlockingQueueAPI<Integer> linkedBlockingQueue = new ImplementLinkedBlockingQueueAPI<Integer>();
        try
        {
