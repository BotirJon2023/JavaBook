...
public class DrawASmilingFaceUsingGraphicsClassMethods extends JPanel {
    ...
    public static void main(String args[])
    {
        ...
        DrawASmilingFaceUsingGraphicsClassMethods panel=new DrawASmilingFaceUsingGraphicsClassMethods();
        frame.add(panel);
