...
public class CreateAColorDialogBoxToChangeTheBackgroundColorOfFrame implements ActionListener {
    ...
    public static void main(String args[])
    {
        ...
        //Create an object
        CreateAColorDialogBoxToChangeTheBackgroundColorOfFrame obj = new CreateAColorDialogBoxToChangeTheBackgroundColorOfFrame();
        //Create a button
